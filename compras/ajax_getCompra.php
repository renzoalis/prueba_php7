<?php
	...
	$do_compras_detalle -> joinAdd($do_producto_stock,"LEFT");
	...
	$hayproductos = 0; // Cuento si hay productos que se pueda devolver -> con ppv = 0
	...
	while ($do_compras_detalle -> fetch()) { 
		...
		if($do_compras_detalle -> ps_precio_prom_venta == 0){
			$hayproductos++;
		}
	}
	...
	$do_conceptos2 -> whereAdd('cc_compra_id = '.$_POST['id']);
	$do_conceptos2 -> find();
