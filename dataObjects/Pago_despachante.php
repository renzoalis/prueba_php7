<?php
/**
 * Table Definition for pago_despachante
 */
require_once 'DB/DataObject.php';

class DataObjects_Pago_despachante extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'pago_despachante';    // table name
    public $pago_id;                         // int(11)  not_null primary_key auto_increment group_by
    public $pago_fh;                         // datetime(19)  not_null
    public $pago_despach_id;                 // int(11)  not_null group_by
    ...
    /* Static get */
    //function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_Pago_despachante',$k,$v); }
    ...
    function nuevoPago($objeto) {
       ...
       // print_r($objeto);exit;
        ...
        $this -> pago_despach_id = $objeto['input_id_despach'];
        ...
        if($objeto['combo_fpago'] == 6){    //CHEQUE TERCEROS   
            ...
            $do_cheque -> find(true);
            $do_cheque -> cheque_despachante_fh = date('Y-m-d H:i:s');
            $do_cheque -> cheque_despachante_id = $objeto['input_id_despach'];
            $do_cheque -> cheque_estado = 8;
            ...
            $do_cheque_propio -> cheque_despachante_id = $objeto['input_id_despach'];
            ...
            $do_cheque_propio -> cheque_estado = 8;
            ...
            $objeto['input_monto_total'] =  $objeto['input_monto_despach'];
