<?php
/**
 * Table Definition for saluidas_de_caja
 */
require_once 'DB/DataObject.php';

class DataObjects_Saluidas_de_caja extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'saluidas_de_caja';    // table name
    ...
    /* Static get */
    //function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_Saluidas_de_caja',$k,$v); }
