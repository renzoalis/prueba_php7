<?php
/**
 * Table Definition for pago_importador
 */
require_once 'DB/DataObject.php';

class DataObjects_Pago_importador extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'pago_importador';     // table name
    public $pago_id;                         // int(11)  not_null primary_key auto_increment group_by
    public $pago_fh;                         // datetime(19)  not_null
    public $pago_importad_id;                // int(11)  not_null group_by
    ...
    /* Static get */
    //function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_Pago_importador',$k,$v); }
    ...
    function nuevoPago($objeto) {
       ...
       // print_r($objeto);exit;
        ...
        $this -> pago_importad_id = $objeto['input_id_importad'];
        ...
        if($objeto['combo_fpago'] == 6){    //CHEQUE TERCEROS   
            ...
            $do_cheque -> find(true);
            $do_cheque -> cheque_importador_fh = date('Y-m-d H:i:s');
            $do_cheque -> cheque_importador_id = $objeto['input_id_importad'];
            $do_cheque -> cheque_estado = 9;
            ...
            $do_cheque_propio -> cheque_importador_id = $objeto['input_id_importad'];
            ...
            $do_cheque_propio -> cheque_estado = 9;
            ...
            $objeto['input_monto_total'] =  $objeto['input_monto_importad'];
