<?php
/**
 * Table Definition for pago_exportador
 */
require_once 'DB/DataObject.php';

class DataObjects_Pago_exportador extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'pago_exportador';     // table name
    public $pago_id;                         // int(11)  not_null primary_key auto_increment group_by
    public $pago_fh;                         // datetime(19)  not_null
    public $pago_exportad_id;                // int(11)  not_null group_by
    ...
    /* Static get */
    //function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_Pago_exportador',$k,$v); }
    ...
    ###END_AUTOCODE
     function nuevoPago($objeto) {
       ...
       // print_r($objeto);exit;
        ...
        $this -> pago_exportad_id = $objeto['input_id_exportad'];
        ...
        if($objeto['combo_fpago'] == 6){    //CHEQUE TERCEROS   
            ...
            $do_cheque -> find(true);
            $do_cheque -> cheque_exportador_fh = date('Y-m-d H:i:s');
            $do_cheque -> cheque_exportador_id = $objeto['input_id_exportad'];
            $do_cheque -> cheque_estado = 10;
            ...
            $do_cheque_propio -> cheque_exportador_id = $objeto['input_id_exportad'];
            ...
            $do_cheque_propio -> cheque_estado = 10;
            ...
            $objeto['input_monto_total'] =  $objeto['input_monto_exportad'];
